...
= {
   ...
   { "ratioTrackingForAO", OWL_BOOL, OWL_OFFSETOF(LaunchParams,ratioTrackingForAO) },
   { "ratioTrackingForShadows", OWL_BOOL, OWL_OFFSETOF(LaunchParams,ratioTrackingForShadows) },
   // render settings
